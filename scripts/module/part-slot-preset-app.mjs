...
export const DEFAULT_PART_SLOT_PRESET = Object.freeze((() => {
  ...
  return [
    ...
    s("ゴーグル"), s("眼部"), s("眼球"), s("コンタクトレンズ"), s("涙腺"), s("鼻"),
    s("耳"), s("両耳"), s("内耳"), s("口腔"), s("唇"), s("唇の皮膚"), s("舌"), s("マスク"), s("ヘルメット"),
    // 脳・神経・精神
    s("脳"), s("大脳"), s("小脳"), s("脳皮質"), s("脳下垂体"), s("神経"), s("精神"),
    // 首・肩
    s("首"), s("喉"), s("肩"), s("肩胛骨"),
    // 胴・装着
    s("胴体"), s("背中"), s("脇腹"), s("腰"), s("下半身"),
    s("アンダーウェア"), s("スーツ"), s("コート"), s("アーマー"), s("装飾品"), s("鞄"),
    // 内臓
    ...
    // 全身・組織・特殊
    s("全身"), s("皮膚"), s("肌"), s("筋肉"), s("骨格"), s("細胞"), s("全身の細胞"),
    s("生身"), s("義体"), s("電脳"), s("操縦"),
    s("独立"), s("護符"), s("結界"), s("血統"), s("各部"),
  ];
})());
