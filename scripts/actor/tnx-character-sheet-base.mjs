...
import { readFlag, isOutfitDestroyed, isOutfitMalfunctioning } from '../data/item/helpers.mjs';
...
import { resolveItemNameByKey, calcSkillInsertSort } from '../core/identification.mjs';
...
export class TnxCharacterSheetBase extends HandlebarsApplicationMixin(ActorSheetV2) {
    ...
    async _prepareOutfitGroups() {
        ...
        return TnxCharacterSheetBase.OUTFIT_GROUP_CONFIG.map(cfg => {
